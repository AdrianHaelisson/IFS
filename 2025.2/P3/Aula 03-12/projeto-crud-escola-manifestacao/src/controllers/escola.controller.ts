...
export class EscolaController {
    ...
    getEscolaMaisManifestacao = async (req: Request, res: Response) => {
      const escola = await this.repo.getEscolaMaisManifestacao()
      res.json(escola)
    }
    getEscolaMaisAlunos = async (req: Request, res: Response) => {
      const escola = await this.repo.getEscolaMaisAlunos()
      res.json(escola)
    }
