...
export default function Editor() {
  ...
  const conflicts = [
    ...
    "indivíduo contra natureza",
    "indivíduo contra si mesmo",
    "indivíduo contra destino/sorte",
    "indivíduo contra máquina",
    "indivíduo contra sistema",
...
ambientada em um(a) "${ambient}" no tempo "${time}" para o 
